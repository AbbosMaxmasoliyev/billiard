                                                ...
                                                <li className="index-slider__item swiper-slide swiper-slide-duplicate" style={{ width: "293px", height: "416px" }}>
                                                    <div className="index-slider__inner" style={{ height: "416px" }}>
                                                        <div className="index-slider__img-wrap">
                                                            <a href="https://www.fabrika-start.ru/aksessuary_dlja_biljarda_kupit/" className="index-slider__img-link">

                                                            </a>
                                                        </div>
                                                        <a className="index-slider__title" href="https://www.fabrika-start.ru/aksessuary_dlja_biljarda_kupit/">{name}</a>
                                                        {
                                                            link && <a href="https://www.fabrika-start.ru/aksessuary_dlja_biljarda_kupit/" className="index-slider__detal">Подробнее</a>
                                                        }
                                                    </div>
                                                </li>
                                            ))
