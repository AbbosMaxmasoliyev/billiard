            ...
            <div className="no-index">
                ...
                <div class="wrap-content-left">
                    <div class="with-breadcrumbs" style={{
                        ...
                        <div style={{ backgroundImage: "url(/upload/banner_start_design_hunting.jpg)", width: "800px", height: "206px", marginTop: "50px", position: "relative;" }}>
                        ...
                        <ul class="pricefordownload float-right width772">
                            ...
                            <li style={{ width: "100%", marginTop: "20px" }}><center><img src="/upload/fbs_rk2.png" /><center></center></center></li>
                        </ul>
