            ...
            <div id='container1'>
                <div className="no-index">
                    <div className='wrap-content-left'>
                        ...
                        {
                            data.sizes ? <Table data={data.table} sizesData={data.sizes} parametres={data.parametres} /> : null
                        }
                        {
                            data.description ? <Properties opisaniya={data.description} material={material} /> : null
                        }
                    </div>
